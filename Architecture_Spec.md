...
| [cite_start]673380593-1  | นายพชรดนัย สุดชาติ  | เครือข่ายเมืองอัจฉริยะ (Smart City Network)  | ระบบรับรู้บริบท (Context-aware System) ทำงานด้วย AI-native Network และ Identity-based Networking  | ตอบสนองทันทีด้วย Ultra-low Latency ลดอุบัติเหตุ จัดสรรทรัพยากรเมืองอย่างมีประสิทธิภาพ และตรวจจับภัยคุกคามไซเบอร์อัตโนมัติ |
