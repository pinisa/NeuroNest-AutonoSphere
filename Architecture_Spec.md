...
## 6. โครงสร้างการนำเสนองาน (Group Activities: 14.5 mins)

*กำหนดการอ้างอิงจากแผนภาพการนำเสนอ*

| หน้าที่ (Roles) | หัวข้อการนำเสนอ (Activities) | เวลา (Time) |
| :--- | :--- | :--- |
| **Architect, Engineer, Specialist** | Project Pitch, Architecture Specification | 5 นาที |
| **Engineer, Specialist, DevOps** | Sprint Plan, Mockup | 5 นาที |
| **Specialist, Tester/QA** | Mockup, Test Plan | 4 นาที |
